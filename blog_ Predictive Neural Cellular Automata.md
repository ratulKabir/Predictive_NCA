...
<div align='center'> 
    ![Fig 19: Results of training a PCN with subtraction error.](media/not-square.mp4) <br>
    
</div>

<div align='center'> 
    ![Fig 20: Results of training a PCN with MSE error. After 60 train steps the figures starts to get destroyed because of NaN values in the error matrix.](media/square.mp4) <br>
...
**_Warning_:** If you suffer from epilepsy, photosensitive seizures, or related problems please do no watch Fig. 21 in Experiment 4. It has some flashing of light effects which can be difficult for you.
<div align='center'> 
    ![Fig 21: Results of using changing precesions for different error values.](media/pre1.mp4) <br>
...
<div align='center'> 
    ![Fig 23: Final results of the Predictive NCA model](media/pnca.mp4) <br>
